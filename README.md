## Welcome to the open banking swagger specification
...
#### API Docs
Our API specification is available at the following link. [Click here for the API documentation](https://sentenial.github.io/nuapay-files-swagger/docs/redoc.html). 
